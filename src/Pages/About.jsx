  ...
  return (
    <div className="about">
      ...
      <div className="education">
        ...
        <br />
        <p>
          B.Tech - Production Engineering <br />
        ...
        <br />
        <p>
          Higher Secondary Certificate(12th) <br />
      ...
      <div className="work">
        ...
        <p>
          ...
          <a href="https://www.cognizant.com/">Cognizant</a> Technology
          Solutions <br />
          January-2022 - June-2022 <br />
          Working as a full stack developer. HTML | CSS | JavaScript | SQL |
          ADO.NET <br />
          Worked on one practice project also - completed 3 assigned <br />
          tasks on time. Project Name : Medicaps - project was related to
          Medicines <br />
      ...
      <div className="projects">
        ...
        <p>
          <h3>1. Finite Element Analysis of Composite leaf spring</h3>
          This is my Btech final year project. In this project I have analyzed{" "}
          <br />
          the leaf spring in various loading and boundary conditions using{" "}
          <br />
          FEA method in ANSYS software. <br />
          Techonologies Used : ANSYS SOFTWARE, FEA technique
        </p>
        <br />
        <p>
